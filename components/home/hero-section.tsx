...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-sky-900 to-orange-600 text-white pt-28 pb-32 px-4">
      {/* BACKGROUND DECOR */}
      <div className="absolute inset-0 -z-10">
        ...
        {/* glowing blobs */}
        <div className="absolute -top-24 -left-8 w-72 h-72 bg-orange-400/60 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/15 border border-orange-300/60 rounded-full backdrop-blur-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link
                href="/contact"
                className="px-8 py-4 bg-white text-orange-700 rounded-lg font-semibold hover:bg-orange-50 transition-all flex items-center justify-center gap-2 group shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95"
              >
                Get Started Free
              ...
              <a
                ...
                className="px-8 py-4 bg-white/10 border-2 border-orange-200 text-orange-50 rounded-lg font-semibold hover:bg-white/20 transition-all flex items-center justify-center gap-2 backdrop-blur-sm transform hover:scale-105 active:scale-95"
              >
          ...
          <div className="relative hidden md:block">
            <div className="relative">
              {/* glow behind card */}
              <div className="absolute -inset-6 bg-gradient-to-tr from-orange-400/70 via-amber-300/50 to-white/20 blur-3xl" />
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 w-full overflow-hidden leading-none">
        ...
        >
          <path
            fill="#F8FAFC"  /* blends into next bg-slate-50 section */
